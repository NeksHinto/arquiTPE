...
#define __write_char_buffer  11
#define __write_int_buffer  12
#define __write_string_buffer  13
#define __read_char_buffer  14
#define __read_string_buffer  15
#define __beep  16
#define __wait 17
...
unsigned int _syscall(uint64_t arg1, ...);
